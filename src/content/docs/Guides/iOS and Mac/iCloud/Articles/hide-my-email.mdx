...
<Steps>
  ...
  2. Tap on your account name at the top of the settings screen. 3. Tap on
  "iCloud" in the list of options. 4. Under iCloud, tap on "Hide My Email".
  [![Tap on "Hide My
  ...
  5. The Hide My Email screen will show a list of any existing Hide My Email
  ...
  6. Hide My Email will create an email address. Add a label for yourself so you
  ...
  7. On the Mac, click the "Copy Address" button after the email is created,
  ...
  8. Paste the email address into the sign-up form on the website or app. 9. You
  can open Hide My Email in iCloud settings at any time to see a list of your
  Hide My Email addresses and search for them by email address or label. You can
  also choose to deactivate any Hide My Email address you no longer need.
